...
function calculateAcademicHistory(birthYear: number, isEarlyBorn: boolean) {
	...
	return [
		...
		{
			event: '小学校卒業',
			year: adjustedYear + 13,
			month: 3,
			age: isEarlyBorn ? 12 : 12,
		},
		{
			event: '中学校入学',
			year: adjustedYear + 13,
		...
		{
			event: '中学校卒業',
			year: adjustedYear + 16,
			month: 3,
			age: isEarlyBorn ? 15 : 15,
		},
		{
			event: '高校入学',
			year: adjustedYear + 16,
		...
		{
			event: '高校卒業',
			year: adjustedYear + 19,
			month: 3,
			age: isEarlyBorn ? 18 : 18,
		},
		{
			event: '大学入学（4年制）',
			year: adjustedYear + 19,
		...
		{
			event: '大学卒業（4年制）',
			year: adjustedYear + 23,
			month: 3,
			age: isEarlyBorn ? 22 : 22,
		},
	];
}
	...
	const breadcrumbJsonLd = {
		...
		itemListElement: [
			...
			},
			{
				...
				position: 3,
				name: `${year}年生まれ`,
				item: `https://sotsugyoutoshihayamihyou.vercel.app/birth/${year}`,
			},
		],
	};
