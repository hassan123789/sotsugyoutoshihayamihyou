...
const GENERATIONS: Record<string, GenerationResult> = {
	ice: {
		...
		years: '1975〜1981年生まれ',
		description:
			'バブル崩壊後の就職難を経験した「ロスジェネ」世代。逆境に強く、堅実な価値観を持つ。',
		characteristics: [
			'就活で苦労した経験から粘り強い',
			'アナログ→デジタルの変化を体験',
			'コスパ意識が高い',
	...
	pressure: {
		...
		years: '1982〜1987年生まれ',
		description:
			'氷河期とゆとりに挟まれた世代。大谷翔平・羽生結弦など「プレッシャーに強い」人材を輩出。',
		characteristics: [
			'プレッシャーに強いメンタル',
			'ガラケー文化の体現者',
			'「失われた20年」を肌で知る',
	...
	yutori: {
		...
		years: '1988〜1995年生まれ',
		description:
			'「ゆとり教育」を受けた世代。批判されがちだが、実は多様性を重視する先進的な価値観の持ち主。',
		characteristics: [
			'ワークライフバランス重視',
			'「草食系」と呼ばれた',
			'デジタルネイティブ第一世代',
	...
	z: {
		...
		years: '1996〜2009年生まれ',
		description:
			'生まれた時からインターネットがある「スマホネイティブ」。SNSでの発信力が高く、社会問題への意識も高い。',
		characteristics: [
			'スマホ・SNSが生活の一部',
			'「推し活」「タイパ」重視',
			'環境・社会問題への関心が高い',
