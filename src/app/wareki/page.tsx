...
const ERA_DATA = [
	...
	},
	{
		...
		startYear: 1989,
		endYear: 2019,
		startDate: '1989年1月8日〜2019年4月30日',
	},
	{
		name: '昭和',
		romaji: 'Showa',
		...
		startYear: 1926,
		endYear: 1989,
		startDate: '1926年12月25日〜1989年1月7日',
	},
	{
		name: '大正',
		romaji: 'Taisho',
		...
		startYear: 1912,
		endYear: 1926,
		startDate: '1912年7月30日〜1926年12月24日',
	},
	{
		name: '明治',
		romaji: 'Meiji',
		...
		startYear: 1868,
		endYear: 1912,
		startDate: '1868年9月8日〜1912年7月29日',
	},
];
...
export default function WarekiPage() {
	...
	const warekiResult = useMemo(() => {
		const year = parseInt(seirekiInput, 10);
		if (Number.isNaN(year) || year < 1868 || year > 2100) return null;
		return seirekiToWareki(year);
	}, [seirekiInput]);

	// 和暦→西暦の結果
	const seirekiResult = useMemo(() => {
		const year = parseInt(eraYearInput, 10);
		if (Number.isNaN(year) || year < 1) return null;
