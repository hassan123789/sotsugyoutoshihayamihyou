      ...
      tempDiv.innerHTML = `
        <div style="text-align: center; margin-bottom: 24px;">
          ...
          <p style="font-size: 16px; color: #4a5568; margin: 0;">
            生年月日: ${birthYear}年${birthMonth}月${birthDay}日 (${toWareki(birthYear, birthMonth)})
          </p>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
          <thead>
            <tr style="background: #f7fafc;">
              <th style="padding: 10px 8px; text-align: left; border-bottom: 2px solid #e2e8f0; color: #2C5282; font-weight: 600;">年月</th>
              <th style="padding: 10px 8px; text-align: left; border-bottom: 2px solid #e2e8f0; color: #2C5282; font-weight: 600;">イベント</th>
              <th style="padding: 10px 8px; text-align: right; border-bottom: 2px solid #e2e8f0; color: #2C5282; font-weight: 600;">年齢</th>
            </tr>
          </thead>
          <tbody>
            ${events.map((event, i) => `
              <tr style="background: ${i % 2 === 0 ? '#ffffff' : '#f9fafb'};">
                ...
                <td style="padding: 8px; border-bottom: 1px solid #e2e8f0;">
                  <span style="color: ${event.event.includes('入学') ? '#D53F8C' : event.event.includes('卒業') ? '#2C5282' : '#4a5568'}; font-weight: ${event.event.includes('入学') || event.event.includes('卒業') ? '600' : '400'};">
                    ${event.event}
                  </span>
                </td>
        ...
        <p style="text-align: center; font-size: 11px; color: #a0aec0; margin: 0;">
          Generated by 学歴早見表 - sotsugyoutoshihayamihyou.vercel.app
        </p>
      `;
