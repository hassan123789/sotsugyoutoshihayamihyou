...
export const translations: Record<Locale, Translations> = {
	ja: {
		...
		earlyBornExplanationDetail:
			'1月1日〜4月1日生まれの人のこと。学年では前年度生まれと同じ扱いになります。',
	...
	en: {
		...
		faq1A:
			'People born between January 1 and April 1. They are placed in the same grade as those born in the previous fiscal year.',
		faq2Q: 'What if I took a gap year?',
		faq2A:
			'Select the number of gap years in the "Gap Years" field. The university entrance year will be adjusted automatically.',
		faq3Q: 'What if I repeated a grade?',
		faq3A:
			'Open "Advanced Options" and select the number of extra years for the relevant school level.',
		faq4Q: 'What about overseas or correspondence schools?',
		faq4A:
			'This tool is based on the standard Japanese school system (6-3-3-4). Please verify special cases individually.',
		...
		warekiSubtitle:
			'Convert between Western calendar and Japanese eras (Reiwa, Heisei, Showa, Taisho, Meiji)',
	...
	ko: {
		...
		faq4A:
			'이 도구는 일본 표준 학제(6-3-3-4제)를 기준으로 합니다. 특수한 경우는 개별적으로 확인해 주세요.',
